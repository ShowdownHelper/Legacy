...
exports.commands = {
	...
	hex: function (target, room, user) {
		...
		this.sendReplyBox('The hex code of ' + Legacy.nameColor(targetUser, true) + ' is: <font color="' + Legacy.hashColor(targetUser) + '"><b>' + Legacy.hashColor(targetUser) + '</b></font>');
	},
};
...
// hashColor function
Legacy.hashColor = function (name) {
	name = toId(name);
