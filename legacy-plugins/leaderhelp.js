...
exports.commands = {
	...
	leaderhelp: function (target, room, user) {
		...
		return this.sendReplyBox(
			'<b><u><font color="#008ae6">Legacy\'s Leader Commands:</u></b></font><br /><br />' +
			...
			'<b>/givecurrency [user], [amount]</b> - gives a special amount of gold to a user (needs a reason) <br />' +
			'<b>/takecurrency [user], [amount]</b> - removes a special amount of gold from a user (needs a reason) <br />' +
			'<b>/moneylog [number]</b> - to view the last x lines <br />' +
			'<b>/moneylog [text]</b> - to search for text <br />' +
			'<b>/pmall [message]</b> - sends a pm to all users connected to Legacy <br />' +
			'<b>/pmallstaff [message] or /staffpm [message]</b> - sends a pm to all staff members connected to Legacy <br />' +
